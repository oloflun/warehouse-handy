...
export const ProfileButtonTopRight = () => {
  ...
  return (
    <button
      ...
      className="fixed top-4 right-4 z-[100] h-11 w-11 rounded-full bg-primary text-primary-foreground font-semibold shadow-lg ring-2 ring-background hover:opacity-90 focus:outline-none focus-visible:ring-4 focus-visible:ring-ring pointer-events-auto transition-opacity"

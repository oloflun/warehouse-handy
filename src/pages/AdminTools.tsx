...
import { ArrowLeft, ChevronRight, Activity, Sparkles, Code, Brain } from "lucide-react";
  ...
  return (
    <div className="w-full max-w-full px-4 py-6 md:container md:mx-auto md:px-6 space-y-6">
      ...
      <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-3">
        ...
        {/* OpenAI Diagnostik Card */}
        <Card 
          className="hover:shadow-lg transition-shadow cursor-pointer"
          onClick={() => navigate('/openai-diagnostics')}
        >
          <CardHeader className="p-6">
            <div className="flex items-center gap-3">
              ...
              <div className="flex-1">
                <CardTitle className="text-lg">OpenAI Diagnostik</CardTitle>
                <p className="text-sm text-muted-foreground mt-1">
                  Testa OpenAI API och vision-modeller
                </p>
              </div>
              <ChevronRight className="h-5 w-5 text-muted-foreground" />
            </div>
